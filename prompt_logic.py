...
def build_social_prompt(form_data: dict) -> tuple:
    ...
    **1.1. Сильний Вступ (Перші 125 символів):**
    ...
    - **Обов'язково використовуй один із трьох прийомів для вступу:**
      ...
      4. **Не роби в кінці великий cta. просто скажи коротко що можна завжди звернутися за консультацією в direct.
    **1.2. Основна Частина:**
    ...
    **2.1. Довжина:**
    ...
    - Орієнтуйся на оптимальну довжину в **300-500 символів**, оскільки такі тексти, згідно з дослідженнями, привертають більше уваги. оптимально створювати заголовок і ще 3 абзаци.
  ...
  **3.3. Хештеги:**
    ...
    user_prompt_parts = [
        ...
        '- Форматування: кожен відокремлюй порожнім рядком, тобто після абзацу має бути максимум один пустий рядок. і додавай більше емодзі, щоб зробити текст живим.',
