...
def build_social_prompt(form_data: dict) -> tuple:
    ...
    **1.2. Основна Частина:**
    - **Розділяй текст на абзаци:** Ніколи не пиши суцільним полотном. Кожен абзац має містити 2-4 речення. Використовуй для розділення спеціальні пробіли або емодзі. Після абзацу роби відступ перед наступним абзацом.
    ...
    **3.2. Емодзі:**
    - Розміщуй емодзі рівномірно впродовж тексту, щоб вони підсилювали ключові думки і не перевантажували сприйняття. мінімум 1 емодзі на абзац.
